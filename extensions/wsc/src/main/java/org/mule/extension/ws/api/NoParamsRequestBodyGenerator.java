 ...
 */
public class NoParamsRequestBodyGenerator {

  private static final Logger logger = LoggerFactory.getLogger(NoParamsRequestBodyGenerator.class);

  private Definition wsdlDefinition;

  public NoParamsRequestBodyGenerator(Definition wsdlDefinition) {
