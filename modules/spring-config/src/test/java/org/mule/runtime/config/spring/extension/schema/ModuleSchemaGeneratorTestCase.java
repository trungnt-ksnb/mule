...
public class ModuleSchemaGeneratorTestCase {
  ...
  @Parameterized.Parameters(name = "{index}: Validating {1} module")
  public static Collection<Object[]> data() {
    ...
    Function<String, Object[]> stringFunction = moduleName -> {
      ...
      Optional<ModuleExtension> moduleExtensionOptional = moduleLoader.lookup(namespace, new Properties());
      if (moduleExtensionOptional.isPresent()) {
        try {
          return new Object[] {moduleExtensionOptional.get(),
